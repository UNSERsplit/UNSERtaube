...
@Component({
  selector: 'app-record-button-mobile',
    imports: [
        ReactiveFormsModule,
        FormsModule
    ],
  templateUrl: './record-button-mobile.component.html',
  styleUrl: './record-button-mobile.component.css'
})
export class RecordButtonMobileComponent implements OnDestroy {
